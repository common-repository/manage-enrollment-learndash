...
Donate link:
Tags: learndash, grassblade, manage, enrollment, enroll, unenroll, bulk
...
1. Upload the plugin files to the `/wp-content/plugins/manage-enrollment-learndash` directory, or install the plugin through the WordPress plugins screen directly.
1. Activate the plugin through the 'Plugins' screen in WordPress
1. Go to WP ADMIN > GrassBlade > Manage Enrollment for LearnDash or (WP ADMIN > LearnDash > Manage Enrollment)
